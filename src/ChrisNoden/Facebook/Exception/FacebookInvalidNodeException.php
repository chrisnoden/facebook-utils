...
/**
 * Class FacebookInvalidNodeException
 * The requested node (object) does not exist in the Facebook Graph
 *
 ...
 */
class FacebookInvalidNodeException extends FacebookException
{
